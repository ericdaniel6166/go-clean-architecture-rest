...
func (s *Server) MapHandlers(e *echo.Echo) error {
	...
	authUC := authUseCase.NewAuthUseCase(s.cfg, aRepo, nil, nil, nil)
	...
	authHandlers := authHttp.NewAuthHandlers(s.cfg, authUC, nil, nil)
	...
	authHttp.MapAuthRoutes(authGroup, authHandlers, nil)
